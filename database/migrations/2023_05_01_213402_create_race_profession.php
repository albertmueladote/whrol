...
return new class extends Migration
{
    ...
    {
         Schema::create('race_profession', function (Blueprint $table) {
            $table->increments('id_race_profession');
         ...
         DB::table('race_profession')->insert([
            [
                'id_race' => 1,
                'id_profession' => 1,
    ...
    {
        Schema::dropIfExists('race_profession');
    }
};
